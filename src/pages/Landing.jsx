...
const Landing = () => {
  ...
  const groomName = settings?.groom_nickname || "Benjamin";
  const brideName = settings?.bride_nickname || "Angelin";
    ...
    <div className="min-h-screen bg-offwhite flex flex-col items-center justify-center relative overflow-hidden px-4 py-8">
      ...
      <div className="max-w-[600px] w-full text-center z-10 space-y-8 animate-fade-in-up">
        ...
        <div className="inline-block relative">
          <svg
            className="w-24 h-24 text-maroon mx-auto opacity-80"
            viewBox="0 0 100 100"
            fill="none"
            stroke="currentColor"
            strokeWidth="1"
          >
            ...
            <text
              ...
              y="58"
              textAnchor="middle"
              className="font-serif text-2xl fill-maroon italic"
            >
        ...
        <div className="space-y-4">
          <h2 className="text-sm uppercase tracking-[0.3em] text-gray-400 font-light">
            Welcome to the Wedding of
          </h2>
          <h1 className="font-script text-5xl md:text-7xl text-maroon font-normal tracking-wide">
            {groomName} & {brideName}
          </h1>
          <p className="text-gray-400 font-light text-lg italic mt-4">
            {weddingDate}
          </p>
        </div>
        ...
        <div className="space-y-6 max-w-[400px] mx-auto">
          <p className="text-gray-500 font-light leading-relaxed">
            Ini adalah undangan pernikahan yang bersifat privat. Silakan gunakan
            link personal yang telah kami bagikan untuk melihat detail acara dan
            melakukan RSVP.
          </p>
          ...
          <div className="pt-4">
            <button
              disabled
              className="px-8 py-4 bg-white border border-gray-100 text-gray-400 text-xs font-semibold tracking-widest uppercase rounded-full cursor-not-allowed opacity-60"
            >
              Laman Privat
            </button>
          </div>
