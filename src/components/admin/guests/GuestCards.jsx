                ...
                {isDeleted ? (
                  ...
                  <>
                    ...
                    <div className="flex flex-1 gap-1.5">
                      ...
                      {/* Copy link + pesan */}
                      <button
                        onClick={() => copyLinkWithMessage(guest)}
                        title="Copy link + pesan WA"
                        className="flex-1 flex items-center justify-center gap-1 py-2 bg-blue-50 text-blue-600 rounded-xl border border-blue-100 text-xs font-semibold"
                      >
